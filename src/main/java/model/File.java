...
public class File {
    public static String render(String resource, ArrayList<Seat> dataServer) {
        switch (resource.split("\\?")[0]) {
            case "index":
                return indexPage(dataServer);
            case "success":
                return successPage();
            case "failed":
                return failedPage();
    ...
    public static String render(String resource, ArrayList<Seat> dataServer, String slug) {
        switch (resource.split("\\?")[0]) {
            case "reserve":
                return reservePage(slug);
            default:
                return notFoundPage();
        }
    }
    private static String indexPage(ArrayList<Seat> dataServer) {
    ...
    private static String reservePage(String slug) {
        StringBuilder html = new StringBuilder("""
                <!DOCTYPE html>
                <html lang="pt-br">
                  <head>
    ...
    private static String failedPage() {
        return """
                <!DOCTYPE html>
                <html lang="pt-br">
                  <head>
